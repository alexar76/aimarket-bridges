...
this package must not pull in langchain, crewai, autogen or agent-framework. Those do not even
agree on a pydantic version — crewai pins it lower than autogen — so they cannot share one
environment, let alone one import graph. Ask for the one you use:
    ...
    aimarket_bridges.agent_framework  MS Agent Framework     (agent_framework.FunctionTool)
